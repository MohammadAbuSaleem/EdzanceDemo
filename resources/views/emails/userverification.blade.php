                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="32" align="right" valign="middle" style="height:32;line-height:0px">
                                                    <img src="http://hamzeh.ed-zance.com/img/logo.png" height="32" style="border:0">
                                            </td>
                                        </tr>
                            ...
                            <td>
                                <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:collapse">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{URL::to('/').'/user/verify/'.$verificationCode}}" style="color:#593F7F;text-decoration:none;font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:19px;line-height:32px">تفعيل حسابك الشخصي
                                                </a>
                                            </td>
                                        </tr>
                                         <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">
                                                  لقد قمت بالتسجيل على موقع ادزانس, لتفعيل حسابك الرجاء الضغط على الزر الموجود 
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">
                                                <a href="{{URL::to('/').'/user/verify/'.$verificationCode}}" style ="color: #ffffff; background-color: #593F7F; padding: 10px 20px; text-decoration: none; font-size: 17px; line-height: 1.3333333; border: 1px solid #321b51;">
                                                تفعيل الحساب
                                                </a>
                                            </span></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:14px;line-height:19px;color:#898f9c">
                                                سوف ينتهى صلاحية هذا الرابط بعد 6 ساعات، تأكد ان تستخدمه على الفور.
                                            </span></td>
                                        </tr>
                                         <tr>
