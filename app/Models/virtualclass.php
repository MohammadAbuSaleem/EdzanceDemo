...
class virtualclass extends Model
{
    ...
    {
        return $this->hasMany('App\Models\homework', 'virtualclass_id', 'id');
    }
    public function exam()
    {
        return $this->hasMany('App\Models\exam', 'virtualclass_id', 'id');
    }
    public function files()
    {
        return $this->hasMany('App\Models\class_files', 'class_id', 'id');
    }
    public function homeworkCount()
    {
        return $this->hasMany('App\Models\homework', 'virtualclass_id', 'id')->count();
    }
    public function examCount()
    {
        return $this->hasMany('App\Models\exam', 'virtualclass_id', 'id')->count();
    }
    public function filesCount()
    {
        return $this->hasMany('App\Models\class_files', 'class_id', 'id')->count();
    }
    public function post()
    {
        return $this->hasMany('App\Models\classpost', 'class_id', 'id');
    }
    public function user()
    {
        return $this->hasMany('App\Models\classusers', 'class_id', 'id');
    }
    public function vcpost()
    {
        return $this->hasMany('App\Models\classpost', 'users_id', 'id')
    ...
    public function vcuser()
    {
        ...
        return $this->hasMany('App\Models\classusers', 'class_id')
    ...
    {
        $a = $query->hasMany('App\Models\classusers', 'class_id')
    ...
    {
        return $this->hasMany('App\Models\JoinClassRequest', 'class_id', 'id')
            ->join("users", "users.id", "=", "join_class_request.user_id")
            ->where('join_class_request.accept_status', "waiting")
            ->select("users.id", "users.avatar", "users.name", "users.mid_name", "users.last_name", "join_class_request.accept_status", "join_class_request.class_id", "join_class_request.created_at", "join_class_request.user_id")
        ;
    }
