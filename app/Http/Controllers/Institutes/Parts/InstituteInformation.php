...
use App\Controllers\Institutes\Models\variable;
use App\Http\Controllers\Classes\Helper;
use App\Http\Controllers\Controller;
use App\Http\Controllers\PermissionInterface\Permissions;
use App\Models\User;
use Illuminate\Http\Request;

class InstituteInfomation extends Controller implements Permissions
{
    ...
    public static function getInstance()
    {
        ...
        if (self::$instance == null) {
            self::$instance = new InstituteInfomation();
        }
    ...
    {
        return variable::where('institute_id', '$id')->get();
