...
/***/ function(module, exports) {
	...
	var VirtualclassAttendanceController = function () {
	    VirtualclassAttendanceController.$inject = ["$scope", "API", "$stateParams", "$state", "$rootScope", "moment"];
	    function VirtualclassAttendanceController($scope, API, $stateParams, $state, $rootScope, moment) {
	        'ngInject';
	        ...
	        if ($rootScope.vc.instructor != $rootScope.me.id) {
	            API.all('class/attendance/' + $stateParams.classid + '/details/' + $rootScope.me.id).post('').then(function (response) {
	            ...
	            $scope.saveAllAttendance = function (att, attDate) {
	                ...
	                API.all('class/attendance/' + $stateParams.classid + '/add').post(data).then(function (response) {
	                    $scope.attendanceAll = response.data;
