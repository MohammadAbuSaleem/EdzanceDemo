...
/***/ function(module, exports) {
	...
	var VirtualclassesController = function () {
	    VirtualclassesController.$inject = ["$rootScope", "$state", "$scope", "moment", "API", "toastr"];
	    function VirtualclassesController($rootScope, $state, $scope, moment, API, toastr) {
	        'ngInject';
...
/***/ function(module, exports) {
	...
	var GroupDiscussionController = function () {
	    ...
	    function GroupDiscussionController(Post, moment, $state, $sce, $scope, $stateParams, $rootScope, API, $log, $timeout, Upload) {
	        ...
	        this.Post.setskip(0);
	        this.Post.settype('group');
	        this.Post.setsubmiturl('class/set/' + this.stateParams.groupid + '/post');
	        ...
	        value: function editableForm(form) {
	            ...
	            if (form.$valid) {
	                ...
	                (function () {
	                    ...
	                    console.log("------------------");
	                    angular.forEach(self.scope.vc_info, function (value, key) {
