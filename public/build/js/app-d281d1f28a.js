	    ...
	    resolve: {
	      loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
	        return $ocLazyLoad.load({
	          files: ['vendors/sweet-alert/sweet-alert.min.css', 'vendors/material-icons/material-design-iconic-font.min.css', 'css/emojionearea.min.css', 'vendors/socicon/socicon.min.css', 'vendors/light-gallery/lightGallery.min.css', 'css/app.min.1.css', 'css/app.min.2.css', 'css/app.min.3.css']
	        });
	      }]
	    }
	  }).state('app.otherwise', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _booksbankMybooks = __webpack_require__(19);

	var _jobs = __webpack_require__(20);

	var _virtualclassAttendance = __webpack_require__(21);

	var _virtualclassMarks = __webpack_require__(22);

	var _instituteStatistics = __webpack_require__(23);

	var _instituteVirtualclass = __webpack_require__(24);

	var _instituteCourses = __webpack_require__(25);

	var _instituteSettings = __webpack_require__(26);

	var _instituteParents = __webpack_require__(27);

	var _instituteAchievements = __webpack_require__(28);

	var _instituteGroups = __webpack_require__(29);

	var _instituteVacations = __webpack_require__(30);

	var _instituteGrant = __webpack_require__(31);

	var _instituteJobs = __webpack_require__(32);

	var _instituteMessages = __webpack_require__(33);

	var _instituteVolunteering = __webpack_require__(34);

	var _instituteEvents = __webpack_require__(35);

	var _booksbank = __webpack_require__(36);

	var _course = __webpack_require__(37);

	var _courses = __webpack_require__(38);

	var _instituteloginBody = __webpack_require__(39);

	var _instituteloginFooter = __webpack_require__(40);

	var _instituteloginHeader = __webpack_require__(41);

	var _instituteSpecializations = __webpack_require__(42);

	var _instituteDepartment = __webpack_require__(43);

	var _institutes = __webpack_require__(44);

	var _addingInstitutions = __webpack_require__(45);

	var _footerInstitutions = __webpack_require__(46);

	var _headerInstitutions = __webpack_require__(47);

	var _educationalInstitutions = __webpack_require__(48);

	var _instituteMembers = __webpack_require__(49);

	var _instituteAttachments = __webpack_require__(50);

	var _messageRoom = __webpack_require__(51);

	var _groupChat = __webpack_require__(52);

	var _ahmadTest = __webpack_require__(53);

	var _groupsInvitations = __webpack_require__(54);

	var _groupMembersRequests = __webpack_require__(55);

	var _membersRequests = __webpack_require__(56);

	var _groupsIndex = __webpack_require__(57);

	var _groupAll = __webpack_require__(58);

	var _groupRedirect = __webpack_require__(59);

	var _resultsClassexam = __webpack_require__(60);

	var _resultsClasshomework = __webpack_require__(61);

	var _resultsClasspost = __webpack_require__(62);

	var _resultsClassfile = __webpack_require__(63);

	var _virtualclassInstructions = __webpack_require__(64);

	var _otherwise = __webpack_require__(65);

	var _registrationEducation = __webpack_require__(66);

	var _specializationAttachmentsHomework = __webpack_require__(67);

	var _specializationAttachmentsPhotos = __webpack_require__(68);

	var _specializationAttachmentsVideos = __webpack_require__(69);

	var _specializationAttachmentsFiles = __webpack_require__(70);

	var _specializationAttachments = __webpack_require__(71);

	var _specializationAttachment = __webpack_require__(72);

	var _resultsPost = __webpack_require__(73);

	var _results = __webpack_require__(74);

	var _groupAttachmentsVideos = __webpack_require__(75);

	var _groupAttachmentsPhotos = __webpack_require__(76);

	var _groupAttachmentsPhoto = __webpack_require__(77);

	var _groupAttachmentsFiles = __webpack_require__(78);

	var _groupAttachments = __webpack_require__(79);

	var _support = __webpack_require__(80);

	var _registrationBox = __webpack_require__(81);

	var _loginBox = __webpack_require__(82);

	var _specializationInstructors = __webpack_require__(83);

	var _specializationGroups = __webpack_require__(84);

	var _specializationPhotos = __webpack_require__(85);

	var _specializationVideos = __webpack_require__(86);

	var _specializationFiles = __webpack_require__(87);

	var _specializationStudents = __webpack_require__(88);

	var _specializationHomework = __webpack_require__(89);

	var _specializationMaterials = __webpack_require__(90);

	var _specializationDiscussion = __webpack_require__(91);

	var _specialization = __webpack_require__(92);

	var _search = __webpack_require__(93);

	var _notifications = __webpack_require__(94);

	var _groupOptions = __webpack_require__(95);

	var _groupMembers = __webpack_require__(96);

	var _groupInformation = __webpack_require__(97);

	var _groupFiles = __webpack_require__(98);

	var _groupDiscussion = __webpack_require__(99);

	var _groups = __webpack_require__(100);

	var _group = __webpack_require__(101);

	var _virtualclassUnauthorized = __webpack_require__(102);

	var _virtualclassInformation = __webpack_require__(103);

	var _profileSchedule = __webpack_require__(104);

	var _post = __webpack_require__(105);

	var _comment = __webpack_require__(106);

	var _loginRedirect = __webpack_require__(107);

	var _loginIndex = __webpack_require__(108);

	var _login = __webpack_require__(109);

	var _registerLoader = __webpack_require__(110);

	var _registerMail = __webpack_require__(111);

	var _registerError = __webpack_require__(112);

	var _register = __webpack_require__(113);

	var _registerConfirm = __webpack_require__(114);

	var _registerClass = __webpack_require__(115);

	var _registerInformation = __webpack_require__(116);

	var _registerMain = __webpack_require__(117);

	var _registerType = __webpack_require__(118);

	var _companies = __webpack_require__(119);

	var _companiesVideos = __webpack_require__(120);

	var _companiesPhotos = __webpack_require__(121);

	var _companiesAbout = __webpack_require__(122);

	var _companiesTimeline = __webpack_require__(123);

	var _profileVideo = __webpack_require__(124);

	var _profileMedia = __webpack_require__(125);

	var _profileFollower = __webpack_require__(126);

	var _profileFollowing = __webpack_require__(127);

	var _instituteColleges = __webpack_require__(128);

	var _instituteSpecialties = __webpack_require__(129);

	var _instituteVideos = __webpack_require__(130);

	var _institutePhotos = __webpack_require__(131);

	var _instituteTimeline = __webpack_require__(132);

	var _timeline = __webpack_require__(133);

	var _instituteAbout = __webpack_require__(134);

	var _institute = __webpack_require__(135);

	var _loginUniversitySocial = __webpack_require__(136);

	var _loginConfirmdata = __webpack_require__(137);

	var _loginUniversity = __webpack_require__(138);

	var _virtualclassOptions = __webpack_require__(139);

	var _virtualclassStudent = __webpack_require__(140);

	var _virtualclassExam = __webpack_require__(141);

	var _virtualclassChat = __webpack_require__(142);

	var _virtualclassHomework = __webpack_require__(143);

	var _virtualclassFiles = __webpack_require__(144);

	var _virtualclassDiscussion = __webpack_require__(145);

	var _virtualclass = __webpack_require__(146);

	var _suggestionsfriends = __webpack_require__(147);

	var _message = __webpack_require__(148);

	var _myEnter = __webpack_require__(149);

	var _profile = __webpack_require__(150);

	var _profileConnection = __webpack_require__(151);

	var _profilePhoto = __webpack_require__(152);

	var _profileAbout = __webpack_require__(153);

	var _profileTimeline = __webpack_require__(154);

	var _logHead = __webpack_require__(155);

	var _foot = __webpack_require__(156);
...
/***/ function(module, exports) {
	...
	var VirtualclassAttendanceController = function () {
	    VirtualclassAttendanceController.$inject = ["$scope", "$filter", "$http", "$q", "API", "$stateParams", "$state"];
	    function VirtualclassAttendanceController($scope, $filter, $http, $q, API, $stateParams, $state) {
	        'ngInject';
	        ...
	        // API.all('class/get/'+ $stateParams.classid +'/mark/0/2').get('').then((response) => {
	        //     $scope.users = response.data.users;
	        // });
	        $scope.addNewMark = function () {
	            var size = Object.keys($scope.users[0].marks).length;
	            angular.forEach($scope.users, function (value, key) {
	                value.marks[size + 1] = { mark: '0', assessments_id: 0, exam_name: '' };
	            });
	        };
...
/***/ function(module, exports) {
	...
	var VirtualclassMarksController = function () {
	    VirtualclassMarksController.$inject = ["$scope", "$filter", "$http", "$q", "API", "$stateParams", "$state"];
	    function VirtualclassMarksController($scope, $filter, $http, $q, API, $stateParams, $state) {
	        'ngInject';
...
/***/ function(module, exports) {
	...
	var ResultsClassexamController = function () {
	    ...
	    function ResultsClassexamController(Post, moment, $stateParams, $scope, $rootScope, API, $log, Upload, $timeout, $state) {
	        ...
	        this.Post = new Post.constructor($rootScope, API, $timeout, moment, Upload, $log);
	        var Post = this.Post;
	        this.Post.seturl('vc/exam-page/' + $stateParams.resultsid);
	        ...
	        $scope.permission = function (post, me, acctype) {
	            return post == me || acctype == 2;
	        };
...
/***/ function(module, exports) {
	...
	var ResultsClasshomeworkController = function () {
	    ...
	    function ResultsClasshomeworkController(Post, moment, $stateParams, $scope, $rootScope, API, $log, Upload, $timeout, $state) {
	        ...
	        this.Post = new Post.constructor($rootScope, API, $timeout, moment, Upload, $log);
	        var Post = this.Post;
	        this.Post.seturl('vc/homework-page/' + $stateParams.resultsid);
...
/***/ function(module, exports) {
	...
	var ResultsClasspostController = function () {
	    ...
	    function ResultsClasspostController($scope, $stateParams, moment, API, Post, $rootScope, $timeout, Upload, $log, $state) {
	        ...
	        this.Post = new Post.constructor($rootScope, API, $timeout, moment, Upload, $log);
	        var Post = this.Post;
	        this.Post.seturl('vc/post-page/' + $stateParams.resultsid);
	        ...
	        $scope.permission = function (post, me) {
	            return post == me;
	        };
	        $scope.submitComment = function ($id, $index, $body, place) {
	            Post.submitComment($id, $index, this, $body, place);
...
/***/ function(module, exports) {
	...
	var ResultsClassfileController = function () {
	    ...
	    function ResultsClassfileController(Post, moment, $stateParams, $scope, $rootScope, ContextService, API, $interval, $uibModal, $log, Upload, $timeout, $document, $state) {
	        ...
	        this.Post = new Post.constructor($rootScope, API, $timeout, moment, Upload, $log);
	        var Post = this.Post;
	        this.Post.seturl('vc/class-file-page/' + $stateParams.resultsid);
...
/***/ function(module, exports) {
	...
	var ResultsPostController = function () {
	    ...
	    function ResultsPostController($scope, $stateParams, moment, API, Post, $rootScope, $timeout, Upload, $log, $state) {
	        ...
	        this.Post = new Post.constructor($rootScope, API, $timeout, moment, Upload, $log);
	        var Post = this.Post;
	        this.Post.seturl('me/post-page/' + $stateParams.resultsid);
	        this.Post.setediturl('me/post-update');
	        this.Post.settype('post');
	        this.Post.setskip(0);
	        this.Post.settake(1);
...
/***/ function(module, exports) {
	...
	var GroupMembersController = function () {
	    GroupMembersController.$inject = ["$scope", "$stateParams", "$rootScope", "API", "$state", "Post", "$timeout", "moment", "Upload", "$log"];
	    function GroupMembersController($scope, $stateParams, $rootScope, API, $state, Post, $timeout, moment, Upload, $log) {
	        'ngInject';
	        ...
	        $scope.join = function (userId, status, index, location) {
	            ...
	            API.all('gr/add-to-group/' + $stateParams.groupid + '/' + userId + '/' + status).get('').then(function (response) {
	                if (status == 4) {
	                    ...
	                    $scope.groupModirator.push(response.data.post);
	                    ...
	                    if (location == 1) {
	                        $scope.dat.push(response.data.post);
	                    } else if (location == 2) {
...
/***/ function(module, exports) {
	...
	var GroupInformationController = function () {
	    GroupInformationController.$inject = ["$stateParams", "$scope", "$rootScope", "API"];
	    function GroupInformationController($stateParams, $scope, $rootScope, API) {
	        'ngInject';
	        ...
	        value: function editableForm(form) {
	            ...
	            if (form.$submitted) {
	                ...
	                this.API.all('gr/editgr/' + this.$stateParams.groupid).post(this.$scope.group).then(function (response) {
	                    ...
	                    _this.rootScope.groupObj.data.name = response.data.group.name;
	                    _this.rootScope.groupObj.data.description = response.data.group.description;
	                    _this.rootScope.groupObj.data.privacy = response.data.group.privacy;
	                    _this.rootScope.groupObj.data.taxonomies = response.data.group.taxonomies;
	                    _this.$scope.privacy = _this.$scope.privacytype[response.data.group.privacy_num - 1];
	                });
	            }
	        }
	    }, {
...
/***/ function(module, exports) {
	...
	var GroupDiscussionController = function () {
	    ...
	    function GroupDiscussionController(Post, moment, $state, $sce, $scope, $stateParams, $rootScope, API, $log, $timeout, Upload) {
	        ...
	        this.Post.setimageurl('gr/image');
	        this.Post.settake(2);
	        //this.Post.getPost();
	        this.Post.getPost().then(function (response) {
	            $scope.dat = Post.getPostat();
...
/***/ function(module, exports) {
	...
	var GroupController = function () {
	    GroupController.$inject = ["$scope", "$stateParams", "$rootScope", "API", "$state", "Post", "$timeout", "moment", "Upload", "$log", "toastr"];
	    function GroupController($scope, $stateParams, $rootScope, API, $state, Post, $timeout, moment, Upload, $log, toastr) {
	        'ngInject';
	        ...
	        $scope.join = function (userId, status) {
	            ...
	            self.API.all('gr/add-to-group/' + self.stateParams.groupid + '/' + userId + '/' + status).get('').then(function (response) {
	                self.rootScope.groupObj.member = response.data.post.type;
	                self.$scope.template = response.data.post.template;
	                if (response.data.post.type == 'in') {
	                    self.$scope.btnType = 3;
	                } else if (response.data.post.type == "out") {
	                    self.$scope.btnType = 1;
	                } else if (response.data.post.type == "waiting") {
	        ...
	        $rootScope.usersearch = function (val) {
	            API.all('gr/search-user/' + $stateParams.groupid + '/' + val).get('').then(function (response) {
	                $rootScope.a = [];
	                response.data.u.map(function (item) {
	                    $rootScope.a.push(item);
	                });
	            }, function (response) {
	                $rootScope.a = response.data;
	            });
	            return $rootScope.a;
	        };
	    ...
	    _createClass(GroupController, [{
	        ...
	        value: function addmember(userId, location, index, name, last_name) {
	            ...
	            this.API.all('gr/add-to-group/' + this.stateParams.groupid + '/' + userId + '/5').post(this.rootScope.suggestedIds).then(function (response) {
	                if (location == 2) {
	                    ...
	                    _this2.rootScope.groupsuggested.push(response.suggested);
	                    _this2.rootScope.suggestedIds.push(response.suggested.user_id);
	                }
	        ...
	        value: function changecover() {
	            ...
	            this.API.all('me/upload-file/group_cover').post(data).then(function (response) {
...
/***/ function(module, exports) {
	...
	var VirtualclassInformationController = function () {
	    VirtualclassInformationController.$inject = ["$stateParams", "$scope", "$rootScope", "ContextService", "API", "$uibModal", "AclService", "Upload", "$timeout"];
	    function VirtualclassInformationController($stateParams, $scope, $rootScope, ContextService, API, $uibModal, AclService, Upload, $timeout) {
	        'ngInject';
	        ...
	        $rootScope.to = new Date();
	        $rootScope.to.setHours(0);
	        $rootScope.to.setMinutes(0);
	        this.rscope.to = $rootScope.to;
	        $scope.to_changed = function (to) {
	            this.rscope.newPost.to.setHours(to.getHours());
	            this.rscope.newPost.to.setMinutes(to.getMinutes());
	        };
	        angular.element('html').scrollTop(0);
	        $rootScope.from = new Date();
	        $rootScope.from.setHours(0);
	        $rootScope.from.setMinutes(0);
	        this.rscope.from = $rootScope.from;
	        $scope.from_changed = function (from) {
	            this.rscope.newPost.from.setHours(from.getHours());
	            this.rscope.newPost.from.setMinutes(from.getMinutes());
	        };
	        $scope.hstep = 1;
	        $scope.mstep = 1;
	        this.$uibModal = $uibModal;
	        ...
	        $scope.$watch('vc_info.season', function (newVal, oldVal) {
	            if (newVal !== oldVal) {
	                switch (newVal) {
	                    case 'first':
	                        $scope.showed.season = 'الأول';
	                        break;
	                    case 'second':
	                        $scope.showed.season = 'الثاني';
	                        break;
	                    case 'summer':
	                        $scope.showed.season = 'الصيفي';
	                        break;
	                }
	            }
	        });
	        $scope.$watch('vc_info.Privacy', function (newVal, oldVal) {
	            if (newVal !== oldVal) {
	                switch (newVal) {
	                    case 'private':
	                        $scope.showed.Privacy = 'خاصة';
	                        break;
	                    case 'public':
	                        $scope.showed.Privacy = 'عامة';
	                        break;
	                    case 'custom':
	                        $scope.showed.Privacy = 'مخصصة';
	                        break;
	                }
	            }
	        });
	        ...
	        API.all('class/get/' + $stateParams.classid).get('').then(function (response) {
	            ...
	            $scope.myday = $rootScope.vc.days.split(',');
	            ...
	            // console.log( new Date($rootScope.vc.from))
	            $scope.student = response.data.vcuser;
	            $scope.vc_info = {
	                name: $rootScope.vc.name,
	                Description: $rootScope.vc.Description,
	                class_number: $rootScope.vc.class_number,
	                class_hall: $rootScope.vc.class_hall,
	                book: $rootScope.vc.Books,
	                syllabus: $rootScope.vc.syllabus,
	                days: $rootScope.vc.days,
	                Hours: $rootScope.vc.Hours,
	                from: new Date($rootScope.vc.from),
	                to: new Date($rootScope.vc.to),
	                season: $rootScope.vc.season,
	                Privacy: $rootScope.vc.Privacy
	            };
	        }, function (response) {
	            $scope.student = response.data.vcuser;
	        });
	    ...
	    _createClass(VirtualclassInformationController, [{
	        ...
	        value: function to_changed(to) {
	            this.$rootScope.to.setHours(to.getHours());
	            this.$rootScope.to.setMinutes(to.getMinutes());
	        }
	    }, {
	        key: 'to_update',
	        value: function to_update() {
	            this.$rootScope.to.setFullYear(this.$rootScope.to.date.getFullYear());
	            this.$rootScope.to.setDate(this.$rootScope.to.date.getDate());
	            this.$rootScope.to.setMonth(this.$rootScope.to.date.getMonth());
	        }
	    }, {
	        key: 'from_changed',
	        value: function from_changed(from) {
	            this.$rootScope.from.setHours(from.getHours());
	            this.$rootScope.from.setMinutes(from.getMinutes());
	        }
	    }, {
	        key: 'from_update',
	        value: function from_update() {
	            this.$rootScope.from.setFullYear(this.$rootScope.from.date.getFullYear());
	            this.$rootScope.from.setDate(this.$rootScope.from.date.getDate());
	            this.$rootScope.from.setMonth(this.$rootScope.from.date.getMonth());
	        }
	    }, {
	        key: 'editableForm',
	        value: function editableForm(form) {
	            ...
	            if (form.$valid) {
	                ...
	                (function () {
	                    ...
	                    from.setFullYear(self.scope.vc_info['from'].getFullYear());
	                    from.setDate(self.scope.vc_info['from'].getDate());
	                    from.setMonth(self.scope.vc_info['from'].getMonth());
	                    from.setHours(self.scope.vc_info['from'].getHours() + 2);
	                    from.setMinutes(self.scope.vc_info['from'].getMinutes());
	                    self.scope.vc_info['from'] = from;
	                    to = new Date();

	                    to.setFullYear(self.scope.vc_info['to'].getFullYear());
	                    to.setDate(self.scope.vc_info['to'].getDate());
	                    to.setMonth(self.scope.vc_info['to'].getMonth());
	                    to.setHours(self.scope.vc_info['to'].getHours() + 2);
	                    to.setMinutes(self.scope.vc_info['to'].getMinutes());
	                    self.scope.vc_info['to'] = to;
	                    console.log(self.scope.vc_info);
	                    _this.scope.vc_info.book = '';
	                    _this.scope.vc_info.syllabus = '';
	                    self.scope.ok = 0;
	                    book = _this.scope.Book;
	                    syllabus = _this.scope.syllabus;

	                    if (syllabus) {
	                        if (!syllabus.$error) {
	                            self.Upload.upload({
	                                url: 'api/me/upload-file/vc_syllabus',
	                                method: 'POST',
	                                file: syllabus
	                            }).then(function (resp) {
	                                $timeout(function () {
	                                    self.scope.vc_info.syllabus = resp.data.data.file_name;
	                                    self.scope.ok++;
	                                });
	                            });
	                        } else {
	                    ...
	                    if (book) {
	                        if (!book.$error) {
	                            self.Upload.upload({
	                                url: 'api/me/upload-file/vc_book',
	                                method: 'POST',
	                                file: book
	                            }).then(function (resp) {
	                                $timeout(function () {
	                                    self.scope.vc_info.book = resp.data.data.file_name;
	                                    self.scope.ok++;
	                                });
	                            });
	                        } else {
	                    ...
	                    self.scope.$watch('ok', function () {
	                        if (self.scope.ok == 2) {
	                            self.scope.vc_info.days = self.scope.myday.join(',');
	                            console.log(self.scope);
	                            self.API.all('vc/add-info/' + self.stateParams.classid).post(self.scope.vc_info).then(function (response) {
	                                self.scope.ok = 0;
	                                from.setHours(self.scope.vc_info['from'].getHours() - 2);
	                                self.scope.vc_info['from'] = from;
	                                to.setHours(self.scope.vc_info['to'].getHours() - 2);
...
/***/ function(module, exports) {
	...
	var instituteAboutController = function () {
	  instituteAboutController.$inject = ["$scope", "$log", "$timeout"];
	  function instituteAboutController($scope, $log, $timeout) {
	    'ngInject';

	    _classCallCheck(this, instituteAboutController);

	    $scope.map = { center: { latitude: 31.9695867, longitude: 35.8337067 }, zoom: 12 };
...
/***/ function(module, exports) {
	...
	var VirtualclassStudentController = function () {
	    VirtualclassStudentController.$inject = ["$http", "$stateParams", "$scope", "$rootScope", "ContextService", "API", "AclService", "toastr"];
	    function VirtualclassStudentController($http, $stateParams, $scope, $rootScope, ContextService, API, AclService, toastr) {
	        'ngInject';
	        ...
	        angular.element('html').scrollTop(0);
	        // ContextService.me(function(data) {
	        //     navSideBar.rootScope.prouser = data;
	        // })
	        var _selected;
	        $scope.selected = undefined;

	        $scope.getLocation = function (val) {
	            API.all('class/search/' + $stateParams.classid + '/' + val).get('').then(function (response) {
	                $scope.a = [];
	    ...
	    _createClass(VirtualclassStudentController, [{
	        ...
	        value: function addclasses($item) {
	            ...
	            this.API.all('class/enter/' + this.rootScope.vc.id).post(mynewclass).then(function (response) {
	                _this.rootScope.vc.vcuser = response.data.code;
	                _this.scope.a = [];
	                _this.scope.query = '';
	            });
	        }
	        ...
	        value: function removeclassuser($id) {
	            ...
	            this.API.all('class/leave/' + this.rootScope.vc.id).post(mynewclass).then(function (response) {
	                _this2.rootScope.vc.vcuser = response.data.code;
	                _this2.scope.asyncSelected = '';
	        ...
	        value: function acceptStudent(status, student, index) {
	            ...
	            this.API.all('class/accept/' + this.rootScope.vc.id).post(data).then(function (response) {
	                if (response.errors == true) {
	                    _this3.toastr.error(response.data.message);
	                } else if (response.errors == false) {
	                    _this3.toastr.success(response.data.message);
	                }
	                if (status == 1) {
	                    _this3.scope.waitingStudent.splice(index, 1);
	                    _this3.rootScope.vc.vcuser.push(student);
	                } else if (status == 0) {
	                    _this3.scope.waitingStudent.splice(index, 1);
	                }
	                if (_this3.scope.waitingStudent.length == 0) {
	                    _this3.scope.noWaitingStudent = true;
	                }
	            });
	        }
	    }, {
	  ...
	  function VirtualclassExamController(Post, moment, $stateParams, $scope, $rootScope, ContextService, API, AclService, $interval, $uibModal, $log, Upload, $timeout) {
	    ...
	    $scope.addexam = function (form, self) {
	      if (form.$valid) {
	        ...
	        $rootScope.newPost.date = $rootScope.newPost.date.yyyymmdd();
	        $rootScope.newPost.mytime = $rootScope.newPost.mytime.toLocaleTimeString();
...
/***/ function(module, exports) {
	...
	var VirtualclassFilesController = function () {
	    ...
	    function VirtualclassFilesController(Post, moment, $stateParams, $scope, $rootScope, ContextService, API, $interval, $uibModal, $log, Upload, $timeout, $document, $state) {
	        ...
	        //         // console.log($scope)
	        //     }, (response) => {
	        //         console.log('VirtualclassFilesController:' + response.data.errors.message["0"])
	        //     });
	        //}
	    }
...
/***/ function(module, exports) {
	...
	var VirtualclassDiscussionController = function () {
	  ...
	  function VirtualclassDiscussionController(Post, moment, $state, $sce, $scope, $stateParams, $rootScope, API, $interval, AclService, $uibModal, $log, $timeout, Upload, $q) {
	    ...
	    // this.Post.setCommentDeleteUrl('vc/delete-comment');
	    this.Post.settake(2);
	    this.Post.getPost().then(function (response) {
	      $scope.dat = Post.getPostat();
	      $scope.nopost = Post.getnopost();
	    ...
	    $scope.permission = function (post, me) {
	      return post == me || $rootScope.vc.instructor == me;
	    };
	    $scope.submitComment = function ($id, $index, $body, place) {
	      Post.submitComment($id, $index, this, $body, place);
	      this.comment[$id] = "";
	...
	var VirtualclassController = function () {
	    ...
	    function VirtualclassController(Post, $stateParams, $state, $scope, $rootScope, ContextService, API, AclService) {
	        ...
	        $rootScope.req = API.all('class/get/' + $stateParams.classid).get('').then(function (response) {
	            if (response.data.message == 'you are not in this class') {
	                //if (!($rootScope.vc)) {
...
/***/ function(module, exports) {
	...
	var SuggestionsfriendsController = function () {
	  ...
	  function SuggestionsfriendsController(API, Post, $rootScope, $timeout, moment, Upload, $log, $scope) {
	    ...
	    this.API = API;
	    var Post = this.Post;
	    this.Post.seturl('home/suggestAll');
	    this.Post.setediturl('me/post-update');
	    this.Post.settype('result');
	    this.Post.setskip(0);
	    this.Post.settake(6);
	...
	var ProfileController = function () {
	    ...
	    _createClass(ProfileController, [{
	        ...
	        value: function changeavatar() {
	            ...
	            this.API.all('me/upload-file/profile_avatar').post(data).then(function (response) {
	                location.reload();
	        ...
	        key: 'upload',
	        value: function upload(files, $timeout, $scope) {
	            this.Upload.upload({
	            ...
	            }).then(function (resp, $scope) {}, null, function (evt, $scope) {
	                var progressPercentage = parseInt(100.0 * evt.loaded / evt.total);
	                logs = 'progress: ' + progressPercentage + '% ' + evt.config.data.file.name + '\n';
	            });
	        }
	        ...
	        value: function changecover() {
	            ...
	            this.API.all('me/upload-file/profile_cover').post(data).then(function (response) {
...
/***/ function(module, exports) {
	...
	var ProfileAboutController = function () {
	    ...
	    function ProfileAboutController(moment, $stateParams, $scope, $rootScope, API, $http) {
	        ...
	        $scope.getInstitute = function (val, grade) {
	            var instype;
	            console.log(grade);
	            if (grade == 'school' || grade == 'secondery') {
	                instype = 70000;
	            } else {
	                instype = 1;
	            }
	            return $http.get('../api/inst/search-institute/' + instype + '/' + val).then(function (response) {
...
/***/ function(module, exports) {
	...
	var ProfileTimelineController = function () {
	  ...
	  function ProfileTimelineController(moment, $scope, $stateParams, $rootScope, ContextService, API, $state, Post, $timeout, Upload, $log) {
	    ...
	    this.Post = new Post.constructor($rootScope, API, $timeout, moment, Upload, $log);
	    var Post = this.Post;
	    this.Post.seturl('social/get/profile/post/' + this.stateParams.id);
	...
	var NavController = function () {
	  ...
	  function NavController($scope, $http, $rootScope, ContextService, API, $timeout, $state, $sce, toastr, $stateParams, Post, Upload, moment, $log, $interval, screenSize) {
	    ...
	    $scope.seenNotifications = function () {
	      // if(angular.element('.notification-dropdown').hasClass("open")){
	      //   console.log(angular.element('.notification-dropdown'));
	      //   angular.element('.notification-dropdown').removeClass("open");
	      // }
	    ...
	    //$scope.not = this.Post.getNotifications();
	            ...
	            if (isValid && !this.vday) {
	                if (this.classEnabled == true) {
	                    ...
	                    this.API.all('home/addclass').post(mynewclass).then(function (response) {
	                        _this.$rootScope.me.myclass.push(response.data);
	                ...
	                if (this.classEnabled == true) {
	                    ...
	                    this.API.all('home/enterclass').post(mynewclass).then(function (response) {
	                        if (response.data.sucess == false) {
	                            ...
	                            //this.$rootScope.me.myclass.push(response.data.code);
	    ...
	    function ChatController(moment, $crypto, $scope, $rootScope, ContextService, API, chatMessages, $state) {
	        ...
	        $rootScope.register_popup = function (id, name) {
	            ...
	            for (var iii = 0; iii < $scope.popups.length; iii++) {
	                ...
	                if (id == $scope.popups[iii].id) {
	                    $scope.popups.splice(iii, 1);
	                    $scope.popups.unshift({ id: id, name: name });
	                    $scope.calculate_popups();
	                    return;
	                }
	            }
	        ...
	        $scope.calculate_popups = function (id) {
	            ...
	            if (width < 540 || $state.current.name == 'app.message.room') {
	                ...
	                $state.go('app.message.room', { Room: id });
...
/***/ function(module, exports) {
	...
	var HomeController = function () {
	    ...
	    function HomeController(Post, moment, $sce, $scope, $stateParams, $state, $rootScope, ContextService, API, $interval, AclService, $uibModal, $log, $timeout, Upload, $q, screenSize) {
	        ...
	        // $scope.exprissionUser = function($index,liker) {
	        // console.log(Post.exprissionUser($index,liker));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routeBody = __webpack_require__(193);

	var _passwordVerify = __webpack_require__(194);

	var _myEnter = __webpack_require__(195);

	var _edView = __webpack_require__(196);

	var _hA = __webpack_require__(197);

	var _postRepeat = __webpack_require__(198);

	var _postNew = __webpack_require__(199);

	var _commentRepeat = __webpack_require__(200);

	var _rM = __webpack_require__(201);

	var _activeFace = __webpack_require__(202);

	var _fileUpload = __webpack_require__(203);

	var _imgModel = __webpack_require__(204);

	var _deleteBox = __webpack_require__(205);

	var _scrollHere = __webpack_require__(206);

	var _lightGallery = __webpack_require__(207);

	var _youtubeVideo = __webpack_require__(208);

	var _autoGrow = __webpack_require__(209);

	var _tagsChips = __webpack_require__(210);

	var _classyLoader = __webpack_require__(211);

	var _metaTag = __webpack_require__(212);

	var _videoPost = __webpack_require__(213);

	var _videoPostPopup = __webpack_require__(214);

	var _userContent = __webpack_require__(215);

	var _liveUrl = __webpack_require__(216);

	var _routeHtml = __webpack_require__(217);

	var _chatBox = __webpack_require__(218);

	var _closeMenu = __webpack_require__(219);

	var _emojoFace = __webpack_require__(220);

	var _whenScrolled = __webpack_require__(221);

	var _scrollBottomOn = __webpack_require__(222);

	var _postInstitute = __webpack_require__(223);

	var _examRepeater = __webpack_require__(224);
	...
	function userContentClass($rootScope) {
	    return {
	        ...
	        link: function link(scope, elements, attr) {
	            ...
	            elements.webuiPopover({ placement: 'auto', padding: false, height: '140', style: 'border-radius: 0px', trigger: 'hover' });
	        }
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatMessages = __webpack_require__(229);
...
/***/ function(module, exports) {
	...
	var PostService = exports.PostService = function () {
	    ...
	    _createClass(PostService, [{
	        ...
	        //setNewcomment(newcomment){this.newcomment = newcomment;}
	        ...
	        //getNewcomment(){return this.newcomment;}
	            ...
	            if ($rootScope.post_delete == true) {
	                ...
	                swal({
	                    ...
	                    if (isConfirm) {
	                        ...
	                        API.all(deleteurl).post(data).then(function (response) {
	                            if (response.data.sucess) {
	                                switch (nodeType) {
	                                    case 'comment':
	                                        parent[node.post_id] = [];
	            ...
	            if (post_enabled == true && $rootScope.post_disable != true) {
	                ...
	                if (files.length > 0 || files.name) {
	                    ...
	                    if (!file.$error) {
	                        ...
	                        //.post(data)
	                        .then(function (response) {
	                            postat.push(response.data.post);
	                            // this.nopost = 1;
	                            _self.checkPostat(1);
	                            callback();
	                            addpost_counter++;
	    ...
	    value: function me(cb) {
	      ...
	      $rootScope.$watch('me', function (nv, $rootScope) {
	        if (nv) {
	          ...
	          if (nv.activated_at) {
	            self.$rootScope.meFlag = false;
	          } else {
	            self.$rootScope.meFlag = true;
	          }
	          cb(nv);
	        }
	      });
	    ...
	    _createClass(chatMessagesService, [{
	        ...
	        value: function signUp(fulfill, reject, u) {
	            ...
	            $firebaseAuth.$createUserWithEmailAndPassword(u.id + '@edzance.com', u.FB_PASS).then(function (user) {
	                ...
	                API.all('chat/set-uid').post(data);
