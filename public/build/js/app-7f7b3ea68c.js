	        ...
	        value: function editableForm(form) {
	            ...
	            if (form.$valid) {
	                ...
	                (function () {
	                    ...
	                    var self = _this;
	                    self.scope.vc_info['from_hour'] = self.scope.vc_info['from'].getHours();
	                    self.scope.vc_info['from_minutes'] = self.scope.vc_info['from'].getMinutes();
	                    self.scope.vc_info['to_hour'] = self.scope.vc_info['to'].getHours();
	                    self.scope.vc_info['to_minutes'] = self.scope.vc_info['to'].getMinutes();
	                    to = new Date();
	                    ...
	                    to.setHours(self.scope.vc_info['to'].getHours());
